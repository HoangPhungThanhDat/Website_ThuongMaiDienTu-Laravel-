        ...
        <div class="max-w-[1200px] mx-auto px-3 py-3">
            ...
            <div class="flex flex-col lg:flex-row gap-6 mt-6">
                ...
                <div class="w-full lg:w-[55%] space-y-4">
                    <div class="border border-red-400 rounded p-3 flex gap-3 items-center max-w-[300px]">
                        <img src="https://encrypted-tbn0.gstatic.com/shopping?q=tbn:ANd9GcShjlVzmscBjsE286Xho73Qulkh6yBokzmLE_rCelX4gIgkxdwZsAzCBY6XIzD-uHlnthNETRrEauT06qsKAoZsCZqGNptsu3QzdBPhmZLnSTbis_p1u1iUBAKnWmQ_hev6zDAO6O8bLIA&usqp=CAc"
                            alt="Cốc sạc nhanh siêu nhỏ 20W Innostyle Ultra Miniclube charger product image"
                            class="w-20 h-20 object-contain" width="80" height="80" />
                    ...
                    <div class="flex items-center gap-2">
                        ...
                        <p class="text-red-400 text-xs border border-red-400 rounded px-1 py-0.5">
                            0.00%
                        </p>
                    </div>
                    <div class="flex flex-wrap gap-2">
                    ...
                    <div class="border border-gray-300 rounded p-3 max-h-[180px] overflow-y-auto text-xs text-blue-600">
                        <p class="font-semibold mb-1">TP Hồ Chí Minh</p>
                        <ul class="list-disc list-inside space-y-1">
                            <li><a href="#" class="hover:underline">1900.63.64.69</a></li>
                            <li>
                                <a href="#" class="hover:underline">15023 Đường Tân Phú, Phường 04, Quận 05, Hồ Chí
                                    Minh</a>
                            </li>
                            <li><a href="#" class="hover:underline">1900.63.64.69</a></li>
                            <li>
                                <a href="#" class="hover:underline">15023 Đường Nguyễn Thị Thập, Phường Tân Phong,
                                    Quận 7, Hồ Chí
                                    Minh</a>
                            </li>
                            <li><a href="#" class="hover:underline">1900.63.64.69</a></li>
                            <li>
                                <a href="#" class="hover:underline">2255 Đường Tân Quang Hiệp, Phường Tân Quang
                                    Hiệp, Quận 12, Hồ
                                    Chí Minh</a>
                            </li>
                            <li><a href="#" class="hover:underline">1900.63.64.69</a></li>
                            <li>
                                <a href="#" class="hover:underline">2162/21 Đường 2 Tháng 9, Phường 12, Quận 10, Hồ
                                    Chí Minh</a>
                            </li>
                            <li><a href="#" class="hover:underline">1900.63.64.69</a></li>
                            <li>
                                <a href="#" class="hover:underline">2162/21 Đường Vạn Ngân, Phường Bình Thọ, Thành
                                    phố Thủ Đức, Hồ
                                    Chí Minh</a>
                            </li>
                        </ul>
                    ...
                    <nav>
                        <div class="nav nav-tabs" id="nav-tab" role="tablist">
                            <button class="nav-link active" id="nav-home-tab" data-bs-toggle="tab"
                                ...
                                aria-selected="true">Sản Phẩm Liên Quan</button>
                            ...
                            <div class="container mt-5">
                                ...
                                <div class="border border-gray-300 rounded p-4 mb-4">
                                    ...
                                    <form id="comment-form">
                                        <textarea id="comment-text" class="w-full border border-gray-300 rounded p-2 mb-3" rows="4"
                                ...
                                <div class="mt-4 flex justify-center">
                                    <button class="px-3 py-1 border border-gray-300 rounded hover:bg-gray-100 transition">
                                        Trước
                                    </button>
                                    <button class="px-3 py-1 border border-gray-300 rounded bg-blue-600 text-white mx-1">
                                        1
                                    </button>
                                    <button class="px-3 py-1 border border-gray-300 rounded hover:bg-gray-100 transition">
                                        2
            ...
            <div class="mt-6 max-w-[1200px] mx-auto grid grid-cols-1 lg:grid-cols-3 gap-4 text-[10px] font-semibold">
                <section class="bg-yellow-100 border border-yellow-400 rounded p-3 text-yellow-900 space-y-1">
