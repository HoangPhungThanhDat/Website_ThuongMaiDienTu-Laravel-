                            ...
                            <tr class="border-b border-[#E4E7F1]">
                                <td class="py-2 flex items-center gap-3">
                                    <img src="{{ asset('images/products/' . $row_cart['image']) }}"
                                        alt="{{ $row_cart['name'] }}" class="w-[60px] h-[60px] object-contain rounded">
                    ...
                    @else
                        <form action="{{ route('site.cart.docheckout') }}" method="post">
                            ...
                            <div class="mt-4">
                                ...
                                <textarea name="note"
                                    class="w-full border border-[#E4E7F1] rounded px-3 py-2 text-xs text-[#6B7280] focus:outline-none focus:ring-1 focus:ring-blue-600"></textarea>
                            </div>
                            <div class="mt-4 text-end">
                                <button type="submit"
                                    class="bg-red-600 text-white text-xs font-semibold rounded px-3 py-2 hover:bg-red-700">ĐẶT
                                    MUA</button>
                            </div>
                        </form>
                    @endif
