...
@section('content')
    <div class="container mt-5">
        ...
        <div class="flex flex-col lg:flex-row gap-6">
            <div
                class="w-full lg:w-[280px] bg-white rounded-2xl shadow-xl border border-gray-200 p-6 animate-fade-in overflow-y-auto max-h-[500px] scrollbar-thin scrollbar-thumb-gray-300 hover:scrollbar-thumb-gray-400">
