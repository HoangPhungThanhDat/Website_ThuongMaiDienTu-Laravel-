                        ...
                        @foreach ($list as $row)
                            <tr>
                                ...
                                <td class="text-center">
                                    ...
                                    @endphp
                                    <?php if ($row->status == 1): ?>
                                    <a href="{{ route('admin.product.status', $argrs) }}" class="btn btn-sm btn-success">
                                    ...
                                    <a href="{{ route('admin.product.status', $argrs) }}" class="btn btn-sm btn-danger">
                                        <i class="fa fa-toggle-off" aria-hidden="true"></i>
                                    </a>
                                    <?php
                                    endif;
                                  ?>
                                    <a href="{{ route('admin.product.show', $argrs) }}" class="btn btn-sm btn-info">
                                        <i class="fa fa-eye" aria-hidden="true"></i>
                                    </a>
                                    <a href="{{ route('admin.product.edit', $argrs) }}" class="btn btn-sm btn-primary">
                                        <i class="fa fa-edit" aria-hidden="true"></i>
                                    </a>
                                    <a href="{{ route('admin.product.delete', $argrs) }}" class="btn btn-sm btn-danger">
                                        <i class="fa fa-trash" aria-hidden="true"></i>
                                    </a>
                                </td>
                                <td class="text-center">
