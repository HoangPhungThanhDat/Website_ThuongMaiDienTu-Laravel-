      ...
      <div class="card-body">
        <form action="{{route ('admin.topic.update',['id'=>$topic->id])}}" method="post" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <textarea name="description" id="description" class="form-control">{{old('description',$topic->description)}}
            ...
            <div class="mb-3">
                <button type="submit" name="create" class="btn btn-success">Cập Nhật Chủ Đề
                    </button>
            </div>
        </form>
    </div>
